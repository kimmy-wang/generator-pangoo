...
module.exports = class extends Generator {
  ...
  initializing() {
    // Welcome
    this.log(yosay('Welcome to the pangoo generator!'))
  }
  ...
  prompting() {
    ...
    const prompts = {
      ...
      askForType: () => {
        ...
        if (extensionType) {
          ...
          if (extensionTypes.indexOf(extensionType) !== -1) {
            generator.extensionConfig.type = `pangoo-${extensionType}`
          } else {
            generator.log(
      ...
      askForProjectDesc: () => {
        ...
        return generator
          .prompt({
            ...
            default: 'A pangoo project generated by see generator.',
          })
          .then(nameAnswer => {
      ...
      askForPackageManager: () => {
        if (['pangoo-loader', 'pangoo-plugin'].indexOf(generator.extensionConfig.type) === -1) {
          return Promise.resolve()
        }
  ...
  writing() {
    ...
    switch (this.extensionConfig.type) {
      case 'pangoo-loader':
        this._writingPangooLoader()
        break
      case 'pangoo-plugin':
        this._writingPangooPlugin()
        break
      default:
